...
# Private
# ###############
var _func_text = GutUtils.get_file_as_text('res://luscinia/addons/gut/double_templates/function_template.txt')
var _init_text = GutUtils.get_file_as_text('res://luscinia/addons/gut/double_templates/init_template.txt')
